...
test("occupied live later ranks stamp Apply so an applicant can take the hop", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-take-apply|data-apply-live|data-apply-after-identity|data-first-click="apply"|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four/,
  );
});
...
test("occupied live #1 lists after Apply so a closer can find the write", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|after Apply|data-first-click="apply"|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three/,
  );
});
...
test("occupied live #1 Apply wins the first click after List a role", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-first-click="apply"|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|after Apply/,
  );
...
test("occupied #1 Apply stays certain after List a role is concentrated", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-first-click="apply"|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|after Apply/,
  );
  assert.doesNotMatch(laterCard, /data-apply-after-list-first/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-two/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-three/);
...
test("occupied live #1 lists after Apply is re-concentrated without another hop", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-list-after-apply-four|data-list-after-apply-three|data-list-after-apply-two|data-list-after-apply-first|data-list-after-apply|after Apply|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-first-click="apply"/,
  );
  assert.doesNotMatch(laterCard, /data-list-after-apply-three/);
  assert.doesNotMatch(laterCard, /data-list-after-apply-four/);
  assert.doesNotMatch(laterCard, /data-list-after-apply-two/);
...
test("occupied #1 Apply stays certain after List a role is re-concentrated", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-apply-after-list-two|data-apply-after-list-first|data-apply-after-list-three|data-first-click="apply"|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|after Apply/,
  );
  assert.doesNotMatch(laterCard, /data-apply-after-list-two/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-first/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-three/);
...
test("occupied #1 Apply stays certain after List a role is re-concentrated again", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-apply-after-list-three|data-apply-after-list-two|data-apply-after-list-first|data-first-click="apply"|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|after Apply/,
  );
  assert.doesNotMatch(laterCard, /data-apply-after-list-three/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-two/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-first/);
