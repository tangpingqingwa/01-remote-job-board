...
test("occupied live sheet stamps Apply as the certain outbound hop", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-take-apply|data-apply-live|data-first-click="apply"|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five/,
  );
});
...
test("occupied #1 Apply stays the certain hop after empty-bay identity leads", () => {
  ...
  assert.ok(afterListFive > afterListFour && apply > afterListFive && bid > apply);
  assert.ok(
    listAfter > apply &&
      listFirst >= listAfter &&
      listTwo >= listFirst &&
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-apply-after-identity|data-first-click="apply"|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five/,
  );
});
...
test("occupied live later ranks stamp Apply so an applicant can take the hop", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-take-apply|data-apply-live|data-apply-after-identity|data-first-click="apply"|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|data-list-after-apply-five|data-list-after-apply-six/,
  );
});
...
test("occupied live #1 lists after Apply so a closer can find the write", () => {
  ...
  assert.ok(afterListFour > afterListThree && afterListFive > afterListFour && apply > afterListFive && listAfter > apply);
  assert.ok(listFirst >= listAfter && listTwo >= listFirst && listThree >= listTwo && listFour >= listThree && listFive >= listFour && listSix >= listFive);
  assert.ok(hopHref > apply && hopHref < bid && listAfter < bid);
  assert.ok(afterCopy > listSix && bid > afterCopy && later > bid);
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|data-list-after-apply-five|data-list-after-apply-six|after Apply|data-first-click="apply"|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five/,
  );
});
...
test("occupied live #1 Apply wins the first click after List a role", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-first-click="apply"|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|data-list-after-apply-five|data-list-after-apply-six|after Apply/,
  );
...
test("occupied #1 Apply stays certain after List a role is concentrated", () => {
  ...
  assert.ok(afterListFive > afterListFour && apply > afterListFive);
  assert.ok(applyHref >= 0 && applyHref < firstClick);
  assert.ok(listAfter > apply && listFirst >= listAfter && listTwo >= listFirst && listThree >= listTwo && listFour >= listThree && listFive >= listFour && listSix >= listFive);
  assert.ok(hopHref > apply && hopHref < bid && listAfter < bid);
  assert.ok(afterCopy > listSix && bid > afterCopy && later > bid);
  assert.ok(laterStamp > later && laterHop > laterStamp);
  assert.ok(claim >= 0 && listRole > claim && firstClick > listRole);
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five|data-first-click="apply"|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|data-list-after-apply-five|data-list-after-apply-six|after Apply/,
  );
  assert.doesNotMatch(laterCard, /data-apply-after-list-first/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-two/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-three/);
...
test("occupied live #1 lists after Apply is re-concentrated without another hop", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-list-after-apply-four|data-list-after-apply-five|data-list-after-apply-six|data-list-after-apply-three|data-list-after-apply-two|data-list-after-apply-first|data-list-after-apply|after Apply|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five|data-first-click="apply"/,
  );
  assert.doesNotMatch(laterCard, /data-list-after-apply-three/);
  assert.doesNotMatch(laterCard, /data-list-after-apply-four/);
  assert.doesNotMatch(laterCard, /data-list-after-apply-five/);
...
test("occupied live #1 lists after Apply is re-concentrated again without another hop", () => {
  ...
  assert.ok(listThree >= listTwo && listFour >= listThree && listFive >= listFour && listSix >= listFive);
...
test("occupied #1 Apply stays certain after List a role is re-concentrated again without another named hop", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-apply-after-list-four|data-apply-after-list-five|data-apply-after-list-three|data-apply-after-list-two|data-apply-after-list-first|data-first-click="apply"|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|data-list-after-apply-five|data-list-after-apply-six|after Apply/,
  );
  assert.doesNotMatch(laterCard, /data-apply-after-list-four/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-five/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-three/);
...
test("occupied live #1 lists after Apply is re-concentrated again so List a role does not disappear", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-list-after-apply-five|data-list-after-apply-six|data-list-after-apply-four|data-list-after-apply-three|data-list-after-apply-two|data-list-after-apply-first|data-list-after-apply|after Apply|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five|data-first-click="apply"/,
  );
  assert.doesNotMatch(laterCard, /data-list-after-apply-five/);
  assert.doesNotMatch(laterCard, /data-list-after-apply-six/);
  assert.doesNotMatch(laterCard, /data-list-after-apply-four/);
...
test("occupied live #1 lists after Apply is re-concentrated again so List a role does not disappear under Apply", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-list-after-apply-six|data-list-after-apply-five|data-list-after-apply-four|data-list-after-apply-three|data-list-after-apply-two|data-list-after-apply-first|data-list-after-apply|after Apply|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five|data-first-click="apply"/,
  );
  assert.doesNotMatch(laterCard, /data-list-after-apply-six/);
  assert.doesNotMatch(laterCard, /data-list-after-apply-five/);
  assert.doesNotMatch(laterCard, /data-list-after-apply-four/);
...
test("occupied #1 Apply stays certain after List a role is re-concentrated again so Apply does not disappear", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-apply-after-list-five|data-apply-after-list-four|data-apply-after-list-three|data-apply-after-list-two|data-apply-after-list-first|data-first-click="apply"|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|data-list-after-apply-five|data-list-after-apply-six|after Apply/,
  );
  assert.doesNotMatch(laterCard, /data-apply-after-list-five/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-four/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-three/);
