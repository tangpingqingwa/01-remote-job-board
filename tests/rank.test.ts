...
test("occupied live later ranks stamp Apply so an applicant can take the hop", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-take-apply|data-apply-live|data-apply-after-identity|data-first-click="apply"|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five|data-apply-after-list-six|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|data-list-after-apply-five|data-list-after-apply-six/,
  );
});
...
test("occupied live #1 Apply wins the first click after List a role", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-first-click="apply"|data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five|data-apply-after-list-six|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|data-list-after-apply-five|data-list-after-apply-six|after Apply/,
  );
...
test("occupied #1 Apply stays certain after List a role is concentrated", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-apply-after-list-first|data-apply-after-list-two|data-apply-after-list-three|data-apply-after-list-four|data-apply-after-list-five|data-apply-after-list-six|data-first-click="apply"|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|data-list-after-apply-five|data-list-after-apply-six|after Apply/,
  );
  assert.doesNotMatch(laterCard, /data-apply-after-list-first/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-two/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-three/);
...
test("occupied #1 Apply stays certain after List a role is re-concentrated again without another named hop", () => {
  ...
  assert.doesNotMatch(
    html.slice(later),
    /data-apply-after-list-four|data-apply-after-list-five|data-apply-after-list-six|data-apply-after-list-three|data-apply-after-list-two|data-apply-after-list-first|data-first-click="apply"|data-list-after-apply|data-list-after-apply-first|data-list-after-apply-two|data-list-after-apply-three|data-list-after-apply-four|data-list-after-apply-five|data-list-after-apply-six|after Apply/,
  );
  assert.doesNotMatch(laterCard, /data-apply-after-list-four/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-five/);
  assert.doesNotMatch(laterCard, /data-apply-after-list-six/);
