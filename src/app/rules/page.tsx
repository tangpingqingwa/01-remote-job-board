...
export const metadata: Metadata = {
  ...
  description:
    "Rank is the bid. Min $5, max $50,000. Older wins ties. Raise pays the difference. Weekly UTC reset. No invented salaries. Global remote.",
};
  ...
  return (
    <main className="doc-page" data-page="rules">
      ...
      <p>
        ...
        alone. <strong>Rank is the bid.</strong> First bid is{" "}
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <strong>newBid − currentBid</strong> only — raise pays the
              difference.
            </td>
          </tr>
          <tr>
